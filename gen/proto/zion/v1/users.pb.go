...
type User struct {
	...
	// User's decentralized identifier (DID), e.g. did:ion:[fingerprint]
	Did string `protobuf:"bytes,2,opt,name=did,proto3" json:"did,omitempty"` // Required; unique
	// User's username, unique in Zion
	Username string `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"` // Required; unique
	// User's display name
	Name string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"` // Optional
	// User's email address for opt-in marketing updates
	Email string `protobuf:"bytes,5,opt,name=email,proto3" json:"email,omitempty"` // Optional
	// User's personal biography that shows on their profile
	Bio string `protobuf:"bytes,6,opt,name=bio,proto3" json:"bio,omitempty"` // Optional
	// URL for user's profile picture
	Picture string `protobuf:"bytes,7,opt,name=picture,proto3" json:"picture,omitempty"` // Optional
	// How many sats it costs to direct-message this user
	PriceToMessage int64 `protobuf:"varint,8,opt,name=price_to_message,json=priceToMessage,proto3" json:"price_to_message,omitempty"` // Optional - Default to 0
}
...
var file_proto_zion_v1_users_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x75,
	...
	,
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x6e, 0x65, 0x77, 0x5f, 0x70, 0x61,
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6e, 0x65,
	0x77, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x3b, 0x0a, 0x10, 0x45, 0x64, 0x69,
	...
	,
	...
	,
