...
// CreateUser ...
func (m *UsersServiceDefaultServer) CreateUser(ctx context.Context, in *CreateUserRequest) (*CreateUserResponse, error) {
	db := m.DB
	if custom, ok := interface{}(in).(UsersServiceUserWithBeforeCreateUser); ok {
		var err error
	...
	if custom, ok := interface{}(in).(UsersServiceUserWithAfterCreateUser); ok {
		var err error
...
// UsersServiceUserWithBeforeCreateUser called before DefaultCreateUserUser in the default CreateUser handler
type UsersServiceUserWithBeforeCreateUser interface {
	BeforeCreateUser(context.Context, *gorm.DB) (*gorm.DB, error)
}

// UsersServiceUserWithAfterCreateUser called before DefaultCreateUserUser in the default CreateUser handler
type UsersServiceUserWithAfterCreateUser interface {
	AfterCreateUser(context.Context, *CreateUserResponse, *gorm.DB) error
}

// EditUser ...
func (m *UsersServiceDefaultServer) EditUser(ctx context.Context, in *EditUserRequest) (*EditUserResponse, error) {
	out := &EditUserResponse{}
	return out, nil
}

// FindById ...
func (m *UsersServiceDefaultServer) FindById(ctx context.Context, in *FindByIdRequest) (*FindByIdResponse, error) {
