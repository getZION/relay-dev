...
func RegisterHubRequestServiceServer(s grpc.ServiceRegistrar, srv HubRequestServiceServer) {
	s.RegisterService(&HubRequestService_ServiceDesc, srv)
}
...
// HubRequestService_ServiceDesc is the grpc.ServiceDesc for HubRequestService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var HubRequestService_ServiceDesc = grpc.ServiceDesc{
